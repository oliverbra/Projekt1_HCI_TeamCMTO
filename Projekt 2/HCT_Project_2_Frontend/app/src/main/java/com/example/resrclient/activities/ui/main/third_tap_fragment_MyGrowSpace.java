...
public class third_tap_fragment_MyGrowSpace extends Fragment {
    ...
    public third_tap_fragment_MyGrowSpace() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.my_gs_third_tap_fragment, container, false);
        ...
        TextView info = v.findViewById(R.id.myGS_nopictures);
        ImageView addButton = v.findViewById(R.id.myGS_addButton);
